...
/* ---- extracted script block ---- */
      ...
      gtag("config", "GT-PJNVZCG", {
        googlesitekit_post_type: "featured_item",
      });
...
/* ---- extracted script block ---- */
      ...
      dataLayer = [];
      dataLayer.push ({ 'authorName': 'Thanh Chương 989' });
      dataLayer.push ({ 'postType': 'featured_item' });
...
/* ---- extracted script block ---- */
      ...
      var wc_store_catalog_pdf_download_local = {
        ...
        ajaxPDFDownloadNonce: "6998d555ff",
      };
      /* ]]> */
...
/* ---- extracted script block ---- */
      ...
      var rocket_beacon_data = {
        ...
        nonce: "af65fa78dc",
        url: "https:\/\/vd-group.net\/du-an\/portfolio\/du-an-am-thanh-hoi-truong-bo-tu-lenh-vung-2-hai-quan",
        is_mobile: false,
