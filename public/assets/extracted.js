...
var _akTs = ( new Date() ).getTime();
["ak_js_1","ak_js_2","ak_js_3"].forEach(function(id){ var el = document.getElementById(id); if(el) el.setAttribute("value", _akTs); });
...
/* ---- extracted script block ---- */
		...
		/* flatsomeVars defined in app.blade.php layout */
