...
/* ---- extracted script block ---- */
      ...
      dataLayer = [];
      dataLayer.push ({ 'authorName': 'audio itc' });
...
/* ---- extracted script block ---- */
      ...
      window.addEventListener('DOMContentLoaded', function() {
                  (function($){
                      $(document).ready(function(){
                          $(window).on('load', function(){
                              if($('.woocommerce.archive .term-description').length > 0){
                                  var wrap = $('.woocommerce.archive .term-description');
                                  var current_height = wrap.height();
                                  var your_height = 300;
                                  if(current_height > your_height){
                                      wrap.css('height', your_height+'px');
                                      wrap.append(function(){
                                          return '<div class="devvn_readmore_taxonomy_flatsome devvn_readmore_taxonomy_flatsome_show"><a class="button is-outline primary-color" title="Read More" href="javascript:void(0);">Xem thêm</a></div>';
                                      });
                                      wrap.append(function(){
                                          return '<div class="devvn_readmore_taxonomy_flatsome devvn_readmore_taxonomy_flatsome_less" style="display: none"><a class="button is-outline primary-color" title="Less" href="javascript:void(0);">Ẩn bớt</a></div>';
                                      });
...
/* ---- extracted script block ---- */
      ...
      var yith_wcan_shortcodes = {
        ...
        query_vars: { product_cat: "loa-array" },
        ...
        scroll_target: "",
        modal_on_mobile: "1",
        session_param: "filter_session",
        show_current_children: "",
        loader:
          "https:\/\/vd-group.net\/wp-content\/uploads\/spinner-1s-200px.gif",
        toggles_open_on_modal: "",
        mobile_media_query: "991",
        base_url: "https:\/\/vd-group.net\/loa-array\/",
        terms_per_page: "10",
        currency_format: {
          symbol: "&#8363;",
          decimal: ".",
        ...
        urls: { render_filter: "\/?wc-ajax=yith_wcan_render_filter" },
        nonces: {
          render_filter: "adbd9f7c9d",
          render_remaining_terms: "29fe797163",
          get_filter_terms: "d6e42fafcd",
        },
...
/* ---- extracted script block ---- */
      ...
      var rocket_beacon_data = {
        ajax_url: "https:\/\/vd-group.net\/wp-admin\/admin-ajax.php",
        nonce: "e2f1ab770d",
        url: "https:\/\/vd-group.net\/loa-array",
        is_mobile: false,
        ...
        elements:
          "img, video, picture, p, main, div, li, svg, section, header, span",
        lrc_threshold: 1800,
        preload_fonts_exclusions: ["api.fontshare.com", "cdn.fontshare.com"],
        processed_extensions: ["woff2", "woff", "ttf"],
