...
gtag("config", "GT-PJNVZCG", {"googlesitekit_post_type":"product"});
...
(function(){var el=document.getElementById("ak_js_4");if(el)el.setAttribute("value",(new Date()).getTime());})();

/* ---- extracted script block ---- */

(function(){var el=document.getElementById("ak_js_5");if(el)el.setAttribute("value",(new Date()).getTime());})();
...
/* <![CDATA[ */
var wc_store_catalog_pdf_download_local = {"ajaxurl":"https:\/\/vd-group.net\/wp-admin\/admin-ajax.php","ajaxPDFDownloadNonce":"548fdb47f9"};
/* ]]> */
