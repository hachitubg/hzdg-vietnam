...
<style>
    ...
    *,::after,::before {
    ...
    .bg-\[url\(\/media\/lib\/15-01-2026\/tca-section-deployment-bg-12012026-1\.png\)\] {
        background-image: url({{ asset('wp-content/uploads/images_hzdg/themanh_icon.png') }})
    }

    .bg-\[url\(\/media\/lib\/15-01-2026\/tca-section-hero-bg-14012026-1\.png\)\] {
        background-image: url({{ asset('wp-content/uploads/images_hzdg/themanh_icon.png') }})
    }
    ...
    .after\:bg-\[url\(\/media\/lib\/27-01-2026\/tca-static-star-icon-27012026-1\.png\)\]::after {
        content: var(--tw-content);
        background-image: url({{ asset('wp-content/uploads/images_hzdg/themanh_00.png') }})
    }
